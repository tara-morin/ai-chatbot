...
export default function Home() {
  ...
  const sendMessage= async()=>{
    setMessage('') //gets message to disapear from textfield after you press send
    ...
    const response= fetch('/api/chat',{
      ...
      return reader.read().then(function processText({done, value}){
        ...
        //this will either decode the text or will just provide an empty string so our program doesn't crash
      setMessages((messages)=>{
